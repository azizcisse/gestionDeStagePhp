...
if (isset($email)) {
  ...
  if ($filtredEmail != true) {
      $validationErrors[] = "Erreur!!! Email  invalide";
...
<div class="input-container">
           <input type="text" required="required" minlength="4"
              title="Le login doit contenir au moins 4 caractèress..."
               name="login" placeholder="Taper le nom d'utilisateur"
                autocomplete="off" class="form-control"/>
                </div>
                <div class="input-container">
            <input type="password" required="required" minlength="3"
              title="Le mot de passe doit contenir au moins 3 caractèress..."
               name="pwd1" placeholder="Taper le mot de passe"
                autocomplete="new-password" class="form-control"/>
                </div>
                <div class="input-container">
             <input type="password" required="required" minlength="3"
              title="Le mot de passe doit contenir au moins 3 caractèress..."
               name="pwd2" placeholder="Retaper le mot de passe"
                autocomplete="new-password" class="form-control"/>
                </div>
             <div class="input-container">
              <input type="email" required="required" name="email"
                   placeholder="Taper votre adresse email" class="form-control"/>
             </div>

                <input type="sutmit" class="btn btn-primary" value="Enregistrer"/>
</form>
<br>
    <?php
